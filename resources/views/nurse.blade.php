                        ...
                        <div class="card-content">
                            ...
                            <div class="toolbar">
                                <!--        Here you can write extra buttons/actions for the toolbar
                                             -->
                                <button class="create-modal btn btn-success"><i class="fa fa-plus"></i> Add Nurse</button>
                            </div>
                            ...
                            <div class="material-datatables">
                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach($admin as $item)
                                        <tr>
                                            <td class="text-center"> <img style="width: 100px; height: 100px" src="{{asset("img/defaultavatar.png")}}" width="20px" height="20px"/>  </td>
                                            ...
                                            <td class="td-actions text-right">
                                                ...
                                                <button type="button" rel="tooltip" class="edit-modal btn btn-warning" data-id="{{$item->id}}"  data-name="{{$item->names}}" data-email="{{$item->email}}" data-phone="{{$item->phone_number}}" data-status="{{$item->status}}" data-role="{{$item->role}}"  data-created="{{$item->created_at}}">
                                                    <i class="material-icons">edit</i>
                                                </button>
                                                <button type="button" rel="tooltip" class="delete-modal btn btn-danger" data-id="{{$item->id}}"  data-name="{{$item->names}}" data-email="{{$item->email}}" data-phone="{{$item->phone_number}}" data-status="{{$item->status}}" data-role="{{$item->role}}"  data-created="{{$item->created_at}}">
    ...
    <div id="create" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{url("/hospital/nurse/add")}}" class="form-horizontal" role="form">
    ...
    <div id="editModal"class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <hr/>
                <form method="post" action="{{url("/hospital/nurse/edit")}}" class="form-horizontal" role="modal">
                    <div class="modal-body">
    ...
    <div id="deleteModal"class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <hr/>
                <form method="post" action="{{url("/hospital/nurse/delete")}}"  role="modal">
                    {{ csrf_field() }}
