                            ...
                            <div class="material-datatables">
                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">Assigned Doctor</th>
                                    ...
                                    @foreach($patient as $item)
                                        ...
                                        $patientTypeID = $item->patient_type_id;
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                ...
                                                <button type="button" rel="tooltip" class="delete-modal btn btn-danger" data-id="{{$item->id}}"  data-name="{{$item->names}}"   data-created="{{$item->created_at}}">
    ...
    <div id="deleteModal"class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <hr/>
                <form method="post" action="{{url("/hospital/patient/delete")}}"  role="modal">
                    {{ csrf_field() }}
