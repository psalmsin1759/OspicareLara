...
class AntenatalBaselineInvestigation extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('antenatal_baseline_investigation', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('antenatal_baseline_investigation');
    }
}
